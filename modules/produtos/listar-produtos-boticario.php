<h1>Estoque O Boticário
<a href="../../../EstoqueVendas/modules/estoque/estoque-boticario.php" class='btn btn-primary'>Emitir Estoque (PDF)</a>
</h1>
<?php

$sql = "SELECT * FROM produtos WHERE empresa_produto = 'boticario' AND estoque_produto >= 1";
$res = $conn->query($sql);
